// Chapter 20, Exercise 06: write a find_and_replace function for Documents based on 20.6.2.
...
try
{
    ...
    ifs >> d;
    int count = find_and_replace_all(d, d.begin(), d.end(), "Bow down\nWhere am I now", "bla-bla-bla");
    if (count)
        print(d);
    else
        cout << "Not found!" << endl;
