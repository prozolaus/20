// Chapter 20, Exercise 09: count words in a Document. Two versions, one with "whitespace-
// separated sequences of characters" as words and one with "sequence of 
...
try
{
    ...
    ifs >> d;
    int count = word_count2(d);
    cout << (count ? to_string(count) : "Not found!") << endl;
}
